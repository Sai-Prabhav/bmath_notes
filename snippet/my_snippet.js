[
    ...
    {
        trigger:
            /([^\\])(exp|log|ln|NN|RR|CC|ZZ|where|disc|mat|if|so|then|st|re|im)/,
        replacement: "[[0]]\\[[1]]",
        options: "rmA",
    },
    ...
    { trigger: "cov", replacement: "\\cov{${0:x}}{${1:y}} $2", options: "mA" },
    { trigger: "cor", replacement: "\\cov{${0:x}}{${1:y}} $2", options: "mA" },
